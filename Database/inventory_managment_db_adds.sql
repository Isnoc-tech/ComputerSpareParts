...
CREATE TABLE `adds` (
  ...
  KEY `staffId_adds_fk` (`staffId`),
  CONSTRAINT `itemId_adds_fk` FOREIGN KEY (`itemId`) REFERENCES `item` (`itemId`),
  CONSTRAINT `staffId_adds_fk` FOREIGN KEY (`staffId`) REFERENCES `warehouse_staff` (`staffId`)
